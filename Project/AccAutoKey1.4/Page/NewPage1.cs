...
{
    public partial class NewPage1 : UserControl
    {
        XmlSerializer xs;
        List<FileConfig> ls;
        private string configPath = Path.GetDirectoryName(Application.ExecutablePath) + "\\config\\page1.xml";
        ...
        private void NewPage1_Load(object sender, EventArgs e)
        {
            this.LoadPage();
        }
